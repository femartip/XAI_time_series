...
def score_different_alphas(dataset_name, datset_type, model_path):
    ...
    for alpha in tqdm(diff_alpha_values):
        ...
        mean_loyaltyOS = calculate_mean_loyalty(batch_org_ts=all_time_series_OS, batch_simplified_ts=all_simplificationsOS, model_path=model_path)
        ...
        mean_loyalty_RDP = calculate_mean_loyalty(batch_org_ts=all_time_series_RDP, batch_simplified_ts=all_simplifications_RDP, model_path=model_path)
